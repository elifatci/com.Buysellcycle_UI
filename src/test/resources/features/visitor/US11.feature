...
Feature:Verify the visibility and functionality of the "New User Zone" menu item on the homepage navigation bar
  ...
  Scenario: TC_01 Test of the "New User Zone" link
    ...
    * verify that clicking on the "New User Zone" menu item should redirect the user to the New-user-zone page
  ...
  Scenario: TC_02 Functionality of the "For You," "Exclusive Price," and "Coupon" sections
    ...
    * verify that "Exclusive Price" section is active and products display with special discount
    * Click on the "Coupon" section" and verify that "Coupon" section is active
